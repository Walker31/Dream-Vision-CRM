...
class FollowUp {
  ...
  factory FollowUp.fromJson(Map<String, dynamic> json) {
    return FollowUp(
      id: json['id'],
      remarks: json['remarks']?.isNotEmpty == true ? json['remarks'] : 'No remarks provided.',
...
class FollowUpPage extends StatefulWidget {
  final int enquiryId;
  final String enquiryName; // To display in the AppBar
...
class _FollowUpPageState extends State<FollowUpPage> {
  ...
  void _fetchFollowUps() {
    _followUpsFuture = _enquiryService.getFollowUpsForEnquiry(widget.enquiryId)
...
// --- Custom Timeline Tile Widget for UI ---
...
class _TimelineTile extends StatelessWidget {
          ...
          child: Column(
            ...
            children: [
              ...
              _buildInfoRow(
                ...
                label: 'Status:',
                value: followUp.statusAfterFollowUp ?? 'Not Changed',
              ),
  ...
  Widget _buildNextFollowUp() {
    ...
    return Container(
      ...
      child: Row(
        children: [
          Icon(Icons.event_repeat_outlined, color: Colors.amber.shade800, size: 20),
